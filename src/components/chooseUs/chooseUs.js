...
const ChooseUs = () => {
  return (
    <div className="flex flex-wrap mt-10 w-[90%] m-auto rounded-lg">
      <div className="w-full md:w-[50%] bg-yellow-200 px-1 py-6 rounded-tr-lg rounded-tl-lg rounded-br-lg rounded-bl-lg sm:p-10 sm:rounded-tl-lg sm:rounded-bl-lg">
