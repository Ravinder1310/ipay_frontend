  ...
  return (
    <Layout title={"About - Ipay"}>
      <div className="bg-blue-200 pb-20">
          <img className="w-full h-[300px] sm:h-[400px] sm:mt-0" src="/images/recharge.png" alt="error" />
        <h1 className=" text-6xl font-bold mt-10 mb-8 text-blue-900">About Us</h1>
        <div className="w-[90%] sm:w-[70%] m-auto text-left pb-20 bg-white p-10 rounded-lg">
